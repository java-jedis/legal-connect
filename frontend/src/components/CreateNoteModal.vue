    ...
    <div class="modal-content">
      ...
      <form @submit.prevent="handleSubmit" class="modal-form">
        ...
        <div class="form-group">
          ...
          <textarea id="content" v-model="form.content" required maxlength="10000" class="form-textarea"></textarea>
        </div>
        <div class="form-group">
...
const emit = defineEmits(['note-created', 'close'])
...
const handleSubmit = async () => {
  ...
  try {
    await caseAssetsAPI.createNote({ ...form.value, caseId: props.caseId })
    emit('note-created')
    closeModal()
  } catch (err) {
