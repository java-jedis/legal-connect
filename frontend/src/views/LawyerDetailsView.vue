...
<script>
import LawyerAvailabilitySection from '../components/LawyerAvailabilitySection.vue'
import LawyerProfileDisplay from '../components/LawyerProfileDisplay.vue'
import LawyerReviewsSection from '../components/LawyerReviewsSection.vue'
