-- Quartz database tables for job persistence
-- This script creates all necessary tables for Quartz to persist jobs, triggers, and scheduler data
-- Made idempotent: no DROP statements, CREATE IF NOT EXISTS, and INSERT ... ON CONFLICT DO NOTHING
...
-- Insert default locks (idempotent)
INSERT INTO QRTZ_LOCKS(SCHED_NAME, LOCK_NAME) VALUES ('LegalConnectScheduler', 'TRIGGER_ACCESS') ON CONFLICT DO NOTHING;
INSERT INTO QRTZ_LOCKS(SCHED_NAME, LOCK_NAME) VALUES ('LegalConnectScheduler', 'JOB_ACCESS') ON CONFLICT DO NOTHING;
INSERT INTO QRTZ_LOCKS(SCHED_NAME, LOCK_NAME) VALUES ('LegalConnectScheduler', 'CALENDAR_ACCESS') ON CONFLICT DO NOTHING;
INSERT INTO QRTZ_LOCKS(SCHED_NAME, LOCK_NAME) VALUES ('LegalConnectScheduler', 'STATE_ACCESS') ON CONFLICT DO NOTHING;
INSERT INTO QRTZ_LOCKS(SCHED_NAME, LOCK_NAME) VALUES ('LegalConnectScheduler', 'MISFIRE_ACCESS') ON CONFLICT DO NOTHING; 